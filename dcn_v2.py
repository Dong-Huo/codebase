...
def dcn_v2_conv(input, offset, mask, weight, bias, stride, padding, dilation, deformable_groups):
    ...
    if _backend is None:
        raise ImportError(
            "Neither torchvision.ops.deform_conv2d nor the legacy DCNv2 extension is available."
        )
